...
const testimonials: Testimonial[] = [
  ...
  },
  {
    name: 'Rahul',
    title: 'Model',
    testimonial: 'Highly recommend! It improved My styling process dramatically.',
  ...
  },
  {
    name: 'prasad',
    title: 'businessmen',
    testimonial: 'I can’t imagine going out without this. Truly a game changer.',
    avatar: 'https://randomuser.me/api/portraits/men/5.jpg',
  },
];
  ...
  return (
    <div className="max-w-7xl mx-auto p-8">
      <div className="relative overflow-hidden">
        ...
        <div
          className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 transition-all transform duration-700"
        >
