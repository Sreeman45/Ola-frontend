          ...
          <div>
            ...
            <div className="flex justify-between w-1/2 ">
              <input
                ...
                className="placeholder-white focus:border-b-2 outline-none"
              ></input>
              <Mail />
            </div>
            <button className="border-white border-2 px-2 py-1 rounded-xl mx-auto mt-4 leading-5 cursor-pointer">
              Submit
            </button>
          </div>
        </section>
